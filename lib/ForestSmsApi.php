...
/**
 * @package		Forest SMS
 * @author		Dave (contact@forestechteam.com)
 * @copyright	Copyright (c) 2021, Forest Tech Innovation.
 * @link		https://forestechteam.com
*/
...
class ForestSmsApi 
{
	 ...
	 */
	public function sendSMS($mobile_no, $message, $device_id= 11, $sim_id = 20, $data_type = 'Plain')
	{
           // $AUTH_KEY = '';
           // $SERVER = 'https://forestechteam.com/sms/admin/index.php?auth_key='.$AUTH_KEY.'&route=api';
	 ...
	 * @param striing 	 $gateway  The forestsms to where message will be sent.
	 ...
	 *  'filterby_schedule_from' => '2021-11-11 00:00:00',
	 *  'filterby_schedule_to' => '2021-11-12 00:00:00',
	 *  'filterby_from' => '2021-11-11 00:00:00',
	 *  'filterby_to' => '2021-11-12 00:00:00',
	 *  'limit' => $limit,
	 * );
	 */
